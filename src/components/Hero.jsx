...
const Hero = () => {
  return (
    <section className="section stack-40">
    ...
    >
      <div className="inline-flex items-center gap-2.5 border border-gray-300 dark:border-gray-600 px-3 py-1.5 rounded-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
        <img className="h-6 w-auto" src={assets.group_profile} alt="users" />
